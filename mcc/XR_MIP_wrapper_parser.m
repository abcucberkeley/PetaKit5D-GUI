...
XR_MIP_wrapper(dataPaths,'axis',axis,'ChannelPatterns',ChannelPatterns,...
    'zarrFile',zarrFile,'largeZarr',largeZarr,'Save16bit',Save16bit,...
    'parseCluster',parseCluster,'parseParfor',parseParfor,'jobLogDir', ...
    jobLogDir,'masterCompute',masterCompute,'cpuOnlyNodes',cpuOnlyNodes, ...
    'cpusPerTask',cpusPerTask,'uuid',uuid,'debug',debug);
