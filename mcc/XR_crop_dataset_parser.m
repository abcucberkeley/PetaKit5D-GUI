...
XR_crop_dataset(dataPaths,resultPaths,bbox,'cropType',cropType,'pad',pad,...
    'lastStart',lastStart,'ChannelPatterns',ChannelPatterns,...
    'zarrFile',zarrFile,'largeZarr',largeZarr,'saveZarr',saveZarr,...
    'BlockSize',BlockSize,'parseCluster',parseCluster,'masterCompute',masterCompute,...
    'jobLogDir',jobLogDir,'cpusPerTask',cpusPerTask,'cpuOnlyNodes',cpuOnlyNodes);
