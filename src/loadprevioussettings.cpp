...
void loadPreviousSettings::runInstallScriptMCC(){
    ...
    #else
    std::string matlabDmg = "MATLAB_Runtime_R2024b_Update_6_maci64.dmg";
...
void loadPreviousSettings::curlMCC(){
    ...
    #ifdef _WIN32
    downloadCmd.append("https://ssd.mathworks.com/supportfiles/downloads/R2024b/Release/6/deployment_files/installer/complete/win64/MATLAB_Runtime_R2024b_Update_6_win64.zip");
    #elif __linux__
    downloadCmd.append("https://ssd.mathworks.com/supportfiles/downloads/R2024b/Release/6/deployment_files/installer/complete/glnxa64/MATLAB_Runtime_R2024b_Update_6_glnxa64.zip");
    #else
    downloadCmd.append("https://ssd.mathworks.com/supportfiles/downloads/R2024b/Release/6/deployment_files/installer/complete/maci64/MATLAB_Runtime_R2024b_Update_6_maci64.dmg.zip");
    #endif
