...
QT_MOC_LITERAL(1, 14, 10), // "sendOutput"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 6) // "output"

    },
    "consoleThread\0sendOutput\0\0output"
};
...
void consoleThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendOutput((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (consoleThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&consoleThread::sendOutput)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void consoleThread::sendOutput(const QString & _t1)
{
